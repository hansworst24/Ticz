...
'    Public Property DeviceContentTemplate As DataTemplate
...
'    Public Property ButtonColumnSpan As Integer
...
'        DeviceContentTemplate = SetDeviceContentTemplate(RoomView, devConfig.DeviceRepresentation)
...
'    Public Function SetDeviceContentTemplate(roomview As String, devrepresentation As String) As DataTemplate

'        If roomview = Constants.ROOMVIEW.ICONVIEW Then ButtonColumnSpan = 2 : Return CType(App.Current.Resources("DeviceIconView"), DataTemplate)
'        If roomview = Constants.ROOMVIEW.GRIDVIEW Then devrepresentation = Constants.DEVICEVIEWS.WIDE : ButtonColumnSpan = 1
'        If roomview = Constants.ROOMVIEW.LISTVIEW Then devrepresentation = Constants.DEVICEVIEWS.WIDE : ButtonColumnSpan = 1

'        Select Case devrepresentation
'            Case Constants.DEVICEVIEWS.ICON
'                ButtonColumnSpan = 2
'                Return CType(App.Current.Resources("DeviceIconView"), DataTemplate)
'            Case Constants.DEVICEVIEWS.WIDE
'                ButtonColumnSpan = 1
'                Select Case Type
'                    Case Constants.DEVICE.TYPE.GROUP : Return CType(App.Current.Resources("DeviceWideGroupView"), DataTemplate)
'                    Case Constants.DEVICE.TYPE.LIGHTING_2
'                        Select Case SwitchType
'                            Case Constants.DEVICE.SWITCHTYPE.DIMMER : Return CType(App.Current.Resources("DeviceWideSliderView"), DataTemplate)
'                            Case Constants.DEVICE.SWITCHTYPE.BLINDS : Return CType(App.Current.Resources("DeviceWideBlindsView"), DataTemplate)
'                            Case Constants.DEVICE.SWITCHTYPE.BLINDS_INVERTED : Return CType(App.Current.Resources("DeviceWideBlindsView"), DataTemplate)
'                            Case Constants.DEVICE.SWITCHTYPE.MEDIA_PLAYER : Return CType(App.Current.Resources("DeviceWideMediaPlayerView"), DataTemplate)
'                        End Select
'                    Case Constants.DEVICE.TYPE.LIGHTING_LIMITLESS
'                        Select Case SwitchType
'                            Case Constants.DEVICE.SWITCHTYPE.DIMMER : Return CType(App.Current.Resources("DeviceWideSliderView"), DataTemplate)
...
'                    Case Constants.DEVICE.TYPE.LIGHT_SWITCH
'                        Select Case SwitchType
'                            Case Constants.DEVICE.SWITCHTYPE.SELECTOR : Return CType(App.Current.Resources("DeviceWideSelectorView"), DataTemplate)
'                        End Select
'                End Select
'                Return CType(App.Current.Resources("DeviceWideView"), DataTemplate)
'            Case Constants.DEVICEVIEWS.LARGE
'                Return CType(App.Current.Resources("DeviceWideView"), DataTemplate)
'        End Select
'    End Function
...
Public Class TiczViewModel
    ...
    Public Async Function Refresh(Optional LoadAllUpdates As Boolean = False) As Task
        ...
        If currentRoom.RoomIDX = 12321 Then
            grp_response = Await Task.Run(Function() (New Domoticz).DownloadJSON((New DomoApi).getAllDevices()))
        Else
