        ...
        If response.IsSuccessStatusCode Then
            ...
            For Each d In devicelist
                ...
                If d.HardwareType = Constants.DEVICE.HARDWARETYPE.LOGITECHMEDIASERVER Then
                    DevToAdd = New LogitechMediaServerDeviceViewModel(d, RoomView)
                Else
                    DevToAdd = New DeviceViewModel(d, RoomView)
                End If
...
Public Class TiczViewModel
    ...
    Public Property ShowLMSRemote As Boolean
        Get
            Return _ShowLMSRemote
        End Get
        Set(value As Boolean)
            _ShowLMSRemote = value
            RaisePropertyChanged("ShowLMSRemote")
        End Set
    End Property
    Private Property _ShowLMSRemote As Boolean
    ...
    Public ReadOnly Property GoBackCommand As RelayCommand(Of Object)
        Get
            Return New RelayCommand(Of Object)(Async Sub(x)
                                                   ...
                                                   If ShowLMSRemote Then
                                                       ShowLMSRemote = False
                                                   ElseIf ShowDeviceGraph Then
