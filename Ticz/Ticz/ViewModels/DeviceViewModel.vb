        ...
        Get
            ...
            If _Device.CustomImage = 0 Then
                ...
                Select Case _Device.TypeImg
                    Case "lightbulb"
                        If isOn Then FileName = "Light48_On.png"
                        If Not isOn Then FileName = "Light48_Off.png"
                    Case "contact"
                        If isOn Then FileName = "contact48_open.png"
                        If Not isOn Then FileName = "contact48.png"
                    Case "temperature"
                        FileName = "temp48.png"
                    Case "LogitechMediaServer"
                        If isOn Then FileName = "LogitechMediaServer48_On.png"
                        If Not isOn Then FileName = "LogitechMediaServer48_Off.png"
                    Case "hardware"
                        FileName = "Percentage48.png"
                    Case "doorbell"
                        FileName = "doorbell48.png"
                    Case "door"
                        If isOn Then FileName = "door48open.png"
                        If Not isOn Then FileName = "door48.png"
                    Case "counter"
                        FileName = "Counter48.png"
                    Case "Media"
                        If isOn Then FileName = "Media48_On.png"
                        If Not isOn Then FileName = "Media48_Off.png"
                    Case "current"
                        FileName = "current48.png"
                    Case "override_mini"
                        FileName = "override_mini.png"
                    Case "error"
                    ...
                    Case "scene"
                        FileName = "push48.png"
                    Case "group"
                        If isOn Then FileName = "pushoff48.png"
                        If Not isOn Then FileName = "push48.png"
                    Case "visibility"
                        FileName = "visibility48.png"
                    Case "rain"
                        FileName = "rain48.png"
                    Case "wind"
                        FileName = "wind48.png"
                    Case "uv"
                        FileName = "uv48.png"
                    Case "dimmer"
                        If isOn Then FileName = "Dimmer48_On.png"
                        If Not isOn Then FileName = "Dimmer48_Off.png"
                    Case "blinds"
                        If isOn Then FileName = "blinds48.png"
                        If Not isOn Then FileName = "blindsopen48.png"
                    Case "push"
                        FileName = "push48.png"
                    Case "pushoff"
                        FileName = "pushoff48.png"
                    Case "lux"
                        FileName = "lux48.png"
                    Case "security"
                        FileName = "security48.png"
                End Select
